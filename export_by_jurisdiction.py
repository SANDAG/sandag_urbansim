...
capacity_sql = 'SELECT parcel_id, scheduled_development, addl_units FROM urbansim_output.res_capacity WHERE jurisdiction_id = ' + str(zone) + 'and schedule_id = ' + str(zsid)
