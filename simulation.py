...
orca.get_table('buildings').to_frame(['building_id','parcel_id','building_type_id','residential_units','residential_price','non_residential_price','distance_to_park','distance_to_school','year_built']).to_csv('data/buildings.csv')
