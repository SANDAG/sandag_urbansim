--------------------------------------------------------------------------------
-------------------------------------------------------------------------------
/* Populate table:  urbansim_output.res_capacity_zoning 
	 acres_constrained: 
...
--DELETE FROM urbansim_output.res_capacity_zoning where jurisdiction_id IN (8) and scenario_id = 1

INSERT INTO urbansim_output.res_capacity_zoning (
...
AND zoning.jurisdiction_id IN (8)
...
-- -- rounding 
UPDATE urbansim_output.res_capacity_zoning res
...
res.jurisdiction_id IN (8) AND res.scenario_id = 1;


-- calculate minimum_of_max_dua_units_and_max_res_units for parcels 
UPDATE urbansim_output.res_capacity_zoning
...
and jurisdiction_id IN (8) 
and scenario_id = 1;


-- set siteid for scheduled de
UPDATE urbansim_output.res_capacity_zoning s2
